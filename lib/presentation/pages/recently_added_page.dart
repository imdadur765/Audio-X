        ...
        background: Stack(
          ...
          children: [
            ...
            Positioned(
              right: -50,
              top: -50,
              child: Icon(Icons.access_time_filled_rounded, size: 250, color: Colors.white.withOpacity(0.1)),
            ),
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Image.asset(icon, width: 20, height: 20, color: isPrimary ? Colors.indigo : Colors.white),
    ...
    return Consumer<AudioController>(
      builder: (context, audioController, child) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: isPlaying ? Colors.indigo.withOpacity(0.1) : Colors.white,
            borderRadius: BorderRadius.circular(16),
          ...
          child: ListTile(
            ...
            title: Text(
              ...
              style: TextStyle(
                ...
                color: isPlaying ? Colors.indigo : Colors.black87,
                fontSize: 16,
              ),
            ),
            subtitle: Column(
