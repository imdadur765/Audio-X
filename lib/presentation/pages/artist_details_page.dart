...
class _ArtistDetailsPageState extends State<ArtistDetailsPage> {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final calcHeight = 350.0 - kToolbarHeight - padding;
  ...
  Widget _buildSpotifyStatsCard(Artist artist) {
    return Consumer<AudioController>(
      builder: (context, controller, child) {
        final accentColor = controller.accentColor;
        // Use a safe vibrant version for Spotify stats if extracted color is too dark, or just use accent
        final statsColor = accentColor;
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: statsColor.withOpacity(0.3), width: 1.5),
            boxShadow: [BoxShadow(color: statsColor.withOpacity(0.15), blurRadius: 25, offset: const Offset(0, 10))],
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              if (artist.followers > 0)
                _buildStatRow(
                  ...
                  label: 'Followers',
                  color: statsColor, // Dynamic color
              ...
              if (artist.popularity > 0) ...[
                _buildPopularityBar(artist.popularity, statsColor), // Pass dynamic color
                const SizedBox(height: 20),
              ],
  ...
  Widget _buildPopularityBar(int popularity, Color accentColor) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            Image.asset('assets/images/popularity.png', width: 24, height: 24, color: accentColor),
            const SizedBox(width: 16),
            Text(
              'Popularity',
              style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.grey.shade400),
              ...
              FractionallySizedBox(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: accentColor.withOpacity(0.5), blurRadius: 6, offset: const Offset(0, 0)),
                    ],
                  ),
                ),
              ),
    ...
    return SliverToBoxAdapter(
      child: Padding(
        ...
        child: Consumer<AudioController>(
          builder: (context, controller, child) {
            final accentColor = controller.accentColor;
            final contrastColor = ColorUtils.getContrastText(accentColor);
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset('assets/images/play.png', width: 24, height: 24, color: contrastColor),
                            const SizedBox(width: 8),
                            Text(
                              'Play All',
                              style: TextStyle(color: contrastColor, fontSize: 16, fontWeight: FontWeight.w700),
                            ),
                          ],
                        ),
                      ),
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset('assets/images/shuffle.png', width: 20, height: 20, color: accentColor),
  ...
  void _playSong(List<Song> songs, int index) async {
    ...
    // Use playSongList to correctly set the queue context to this artist's songs
    // BUG FIX: Only play if it's a NEW song. If it's the SAME song, just open player.
    if (audioController.currentSong?.id != selectedSong.id) {
      await audioController.playSongList(songs, index);
    }
